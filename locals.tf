locals {
  project = {
    name                         = "avrtoken"
    github_organization          = "avrtoken"
    terraform_cloud_organization = "avrtoken"
    aws_organizational_unit      = "avrtoken"
    commit_author                = "github-actions[bot]"
    commit_email                 = "github-actions[bot]@users.noreply.github.com"
    organization_email           = "romain.cambonie@gmail.com"
    aws_root_id                  = "r-gw1z"
    aws_management_account       = "ma-ou-avrtoken"
    aws_management_email         = "romain.cambonie+ma-ou-avr@gmail.com"

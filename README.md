# avrtoken Organization Infrastructure

## About
This repository describe through IAC the avrtoken administrative infrastructure that span over Github, Terraform Cloud and an AWS Organizational Unit.
...
Run the ['Apply the changes to avrtoken' workflow](https://github.com/organizations-infrastructure/avrtoken/actions) (time <~ 3 min)
- The infrastructure services; application and presentation repositories have been created and configured in the [avrtoken github organization](https://github.com/ORGANIZATION).
- the [organization admin workspace](https://app.terraform.io/app/organizations-infrastructure/workspaces/avrtoken) is created in terraform cloud admin infrastructure.
- the [organization](https://app.terraform.io/app/avrtoken/workspaces) is created in terraform cloud
- an organizational unit avrtoken and a deployer IAM user have been created in AWS.
